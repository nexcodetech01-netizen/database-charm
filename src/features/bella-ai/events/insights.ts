...
import type { BellaEventModule, BellaEventSeverity } from "./BellaEventTypes";
 ...
 */
export function generateInsights(events: BellaEvent[]): BellaInsight[] {
  const insights: BellaInsight[] = [];
  const byType = new Map<string, BellaEvent[]>();
