 ...
 */
export function isSimplesNacional(crt) {
    const value = crt ?? 1;
...
export function resolveItemTaxes(crt, input, fallbackCsosn) {
    const mei = isMei(crt);
...
export function toFocusTaxFields(groups) {
    return {
