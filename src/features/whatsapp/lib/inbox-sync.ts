...
export type InboxSyncMessage = 
  | { type: "CATALOG_ORDER_RECEIVED"; payload: { ticketId: string; buyerName: string; total: number } }
  | { type: "CATALOG_ORDER_RESOLVED"; payload: { ticketId: string } }
  | { type: "SYNC_COUNT"; payload: { count: number } };
...
export function broadcastInboxEvent(msg: InboxSyncMessage) {
