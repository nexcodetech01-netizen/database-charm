...
// Para garantir que o Vitest intercepte a função, vamos mockar o módulo inteiro
// ANTES de qualquer import do service.
// Usamos a string EXATA que o commercial-inbox.server.ts usa para o import.
