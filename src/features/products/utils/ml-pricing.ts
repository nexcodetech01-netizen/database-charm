export interface MLPricingSettings {
  freeShippingThreshold: number;
  freeShippingValue: number;
  fixedFeeValue: number;
  classicFeePercent: number;
  premiumFeePercent: number;
}

export const DEFAULT_ML_SETTINGS: MLPricingSettings = {
 ...
 */
export function calculateMLFinalPrice(
  desiredNet: number,
  listingType: "gold_special" | "gold_pro",
  settings: MLPricingSettings = DEFAULT_ML_SETTINGS
): number {
 ...
 */
export function calculateMLNetValue(
  finalPrice: number,
  listingType: "gold_special" | "gold_pro",
  settings: MLPricingSettings = DEFAULT_ML_SETTINGS
): number {
