...
export const generateMercadoLivreDescription = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }) => {
    ...
    const system = [
      ...
      "- Estrutura obrigatória, nesta ordem: [Tipo de Produto] + [Marca] + [Modelo] + [Atributo Principal (Cor/Material)].",
      ...
      "- Exemplo correto: 'Bolsa Feminina Fabíola Caramelo Transversal'.",
      "",
      "REGRAS PARA `description` (texto simples padronizado em pt-BR):",
      "- Máximo ABSOLUTO de 4000 caracteres.",
      "- Sem HTML, sem Markdown, sem #, sem **, sem emojis.",
      "- Estrutura exata em tópicos obrigatória (respeitando quebras de linha):",
      "",
      "  [INTRODUÇÃO COMERCIAL]:",
      "  - Escreva de 2 a 3 parágrafos persuasivos destacando elegância, praticidade e durabilidade.",
      "  - Use uma linguagem aspiracional e profissional.",
      "",
      "  FICHA TÉCNICA:",
      "  - [Atributos técnicos relevantes extraídos do contexto]",
      ...
      "",
      "  CUIDADOS:",
      "  - [Orientações de conservação adequadas ao material]",
      "",
      "  GARANTIA:",
      "  - Garantia de 30 dias contra defeitos de fabricação.",
      "",
      "  <1 parágrafo curto de 2-3 linhas sobre o produto>",
