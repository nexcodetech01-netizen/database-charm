...
-- 1. Nova RPC de Receita Diária e Fluxo de Caixa (Single Source of Truth)
...
-- 2. Saneamento: Corrigir paid_at de transações recentes que caíram "no amanhã" devido ao fuso UTC
