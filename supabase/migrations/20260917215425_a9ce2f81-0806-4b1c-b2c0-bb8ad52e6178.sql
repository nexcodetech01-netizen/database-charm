DROP FUNCTION IF EXISTS public.search_products_unaccent(text, uuid, int);
      ...
      AND (
        ...
        OR NOT EXISTS (
            ...
            WHERE NOT (
                ...
                OR lower(public.unaccent(coalesce(p.barcode, ''))) ILIKE '%' || sw.word || '%'
                ...
                OR public.word_similarity(sw.word, lower(public.unaccent(coalesce(p.barcode, '')))) >= 0.4
